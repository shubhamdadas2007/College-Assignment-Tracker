...
COLORS = {
    ...
    "submitted": "#0284c7",      # Sky 600 (Submitted - Awaiting Verification)
    "submitted_bg": "#e0f2fe",   # Sky 100
    "resubmission": "#ea580c",   # Orange 600 (Needs Resubmission)
    "resubmission_bg": "#ffedd5",# Orange 100
}
...
# Task Statuses (Stored in DB with role-based workflow)
TASK_STATUSES = [
    "Pending",
    "In Progress",
    "Submitted",
