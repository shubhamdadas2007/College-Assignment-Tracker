...
def init_db(db_path: Optional[str] = None, seed_demo: bool = True) -> None:
    """
    Initialize SQLite tables if they do not exist, run automatic column migrations,
    ...
    # 3. Create tasks table (Unified entity for all academic work)
    cursor.execute("""
...
def seed_initial_data(conn: sqlite3.Connection) -> None:
    ...
    # 4. Seed Rich Tasks across students
    ...
    cursor.execute("""
        ...
        (2, 1, 'Java OOP Lab 04 - Inheritance', 'Practical', 'Implement class hierarchy and method overriding for Banking System.', ?, ?, 'High', 'Pending', 'Lab Demonstration', 'Need to prepare flowchart and output screenshots.'),
        (2, 2, 'Laplace Transforms Journal', 'Journal', 'Solve exercise problems 4.1 to 4.5 in standard journal format.', ?, ?, 'Medium', 'Pending', 'Hardcopy / Handwritten', 'Get signature from Prof. Sharma.'),
        ...
        (2, 4, 'Flip-Flop Circuit Simulation', 'Practical', 'Simulate JK and D Flip-Flops in Logisim / Proteus.', ?, ?, 'Low', 'Completed', 'Lab Demonstration', 'Verified by lab assistant.'),
